...
//var newThingToDo = "Faire le repas";

//var ul = document.getElementById('todoList');

//var li = document.createTextNode(newThingToDo);

//var query = document.querySelector('button');

//if button.onclick => {
    //li.appendChild(createTextNode(newThingToDo));

//}
    //console.log(newThingToDo);

var newList = "Faire le repas";
var ul = document.getElementById('todoList');
var li = document.createElement('li');
...
//function ajout() {
//	document.getElementById('todoList').innerHTML += "<li>objet</li>";
//}
